...
def _initialize_session_defaults() -> None:
    defaults = {
        ...
        "last_experiment_report_result": None,
        "last_target_study_report_result": None,
        "last_feature_study_report_result": None,
        "last_training_experiment_report_result": None,
        "last_promotion_report_result": None,
        "last_search_report_result": None,
        "last_search_run_result": None,
