...
def render_training_experiment_summary(summary: dict) -> None:
    ...
    detail_items = [
        ...
        ("Trainer", summary.get("trainer_name"), "auto"),
        ("Architecture", summary.get("architecture_name"), "auto"),
        ("Feature Mode", summary.get("feature_mode"), "auto"),
        ("Sequence Channels", summary.get("sequence_feature_count"), "integer"),
        ("Dense Head", summary.get("dense_head_summary"), "auto"),
        ("Bidirectional", summary.get("bidirectional"), "boolean"),
        ("Training Device", summary.get("training_device"), "auto"),
        ("CUDA Device", summary.get("cuda_device_name"), "auto"),
        ("Threshold Source", summary.get("threshold_source"), "auto"),
...
def render_search_summary(summary: dict) -> None:
    ...
    detail_items = [
        ...
        ("Recommended Variant", summary.get("recommended_preset_variant_name"), "auto"),
        ("Recommended Variant Summary", summary.get("recommended_preset_variant_summary"), "auto"),
        ("Preset Meaning", summary.get("recommended_preset_description"), "auto"),
        ("Recommended Architecture", summary.get("recommended_architecture_name"), "auto"),
        ("Recommended Feature Mode", summary.get("recommended_feature_mode"), "auto"),
        ("Recommended Sequence Channels", summary.get("recommended_sequence_feature_count"), "integer"),
        ("Recommended Dense Head", summary.get("recommended_dense_head_summary"), "auto"),
        ("Recommended Bidirectional", summary.get("recommended_bidirectional"), "boolean"),
        ("Recommended Training Device", summary.get("recommended_training_device"), "auto"),
        ("Recommended CUDA Device", summary.get("recommended_cuda_device_name"), "auto"),
        ("Recommended Threshold", summary.get("recommended_selected_threshold"), "float"),
        ("Recommended Threshold Source", summary.get("recommended_threshold_source"), "auto"),
